...
//fix warning by WildCat
__unused static void push_template_insertion_mode(
...
//fix warning by WildCat
__unused static void pop_template_insertion_mode(GumboParser* parser) {
  gumbo_vector_pop(parser, &parser->_parser_state->_template_insertion_modes);
}

__unused static GumboInsertionMode get_current_template_insertion_mode(
    GumboParser* parser) {
